<template>
  <div class="lab-detail-container">
    ...
    <el-table 
      :data="contactInfo" 
      border 
      style="width: 100%; font-family: '宋体'; margin-top: 20px;"
      :header-cell-style="{'text-align':'center', 'font-size':'24px', 'background-color':'transparent'}"
      :cell-style="{'text-align':'center', 'font-size':'18px'}"
    >
